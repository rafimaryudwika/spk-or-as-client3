                        ...
                        <div class="sm:rounded-lg ">
                            <table class="min-w-full shadow-md">
                                <thead class="bg-gray-100 dark:bg-gray-700">
                                    ...
                                    <tr>
                                        <template v-for="subk in state.subkriteria" :key="subk.id_sk2">
                                            <template v-for="subkk in subk.subkriteria" :key="subkk.id_sk2">
                                        ...
                                        <template v-for="subk in state.subkriteria" :key="subk.id_k2">
                                            <template v-for="subkk in subk.subkriteria" :key="subkk.id_sk2">
                                ...
                                <tbody>
                                    <tr v-for="peserta1 in sortedData" :key="peserta1.nim"
                                        ...
                                        <template v-else>
                                            <template v-for="k in state.subkriteria" :key="k.id_k2">
