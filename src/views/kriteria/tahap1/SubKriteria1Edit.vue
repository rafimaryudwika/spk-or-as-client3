                        ...
                        <div class="sm:rounded-lg">
                            ...
                            <div class="mb-6">
                                    ...
                                    <input type="nim" id="disabled-input-2"
                                        ...
                                        disabled readonly v-model="inputSubKriteria.kriteria" />
                                </div>
                                <div class="mb-6">
                                    <label for="nama"
                                        class="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300">Nama Sub-Kriteria</label>
                                    <input type="text" id="nama"
                                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                                        required v-model="inputSubKriteria.subkriteria" />
                                </div>
                                <div class="mb-6">
                                    <label for="bobot"
...
export default {
    ...
    setup() {
        ...
        onMounted(() => {
            subKriteria1API.show(route.params.id)
            .then((response) => {
                state.kriteria = response.data.data
                console.log(state.kriteria)
                    inputSubKriteria.kriteria = response.data.data.kriteria
                    inputSubKriteria.subkriteria = response.data.data.subkriteria
