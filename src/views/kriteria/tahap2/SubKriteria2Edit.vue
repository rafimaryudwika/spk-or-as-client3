        ...
        <div class="p-2">
            <div id="alert-5" class="flex p-4 bg-gray-100 rounded-lg dark:bg-gray-700" role="alert">
                ...
                <div class="ml-3 text-sm font-medium text-gray-700 dark:text-gray-300">
                    Halaman ini berfungsi untuk mengedit sub-kriteria yang diinginkan.<br>
                    Sama halnya halaman Tambah Sub-Kriteria, pengguna bisa mengedit Nama, Kode dan Bobot sub-kriteria
                    namun pengguna tidak dapat mengubah kategori kriteria. Jika
